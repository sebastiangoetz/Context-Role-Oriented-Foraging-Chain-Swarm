...
class testGoalAdaption(unittest.TestCase):
    ...
    #3: Prey detected --> start approximation
    #(afterwards: mock loading and unloading and robot with load detection)
    def testPreyDetectedFullTime(self):
        self.rosNode.publishLight("red", 300.0, -1.2)
        start = time.time()
        ...
        with open('time_PreyDetected.txt', 'a', encoding="utf-8") as f:
